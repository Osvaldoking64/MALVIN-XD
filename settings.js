...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~F31wSAoZ#LYYchJATRUK6whC7BFWZr6NfaLfEOkGAT9FtEOnt0S0",
...
// make true if you want auto reply on status 
        ...
        AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*woow vi o status 😆*",
...
// add img for alive msg
        ...
        LIVE_MSG: process.env.LIVE_MSG || "> ʙᴏᴛ ɪs sᴘᴀʀᴋɪɴɢ ᴀᴄᴛɪᴠᴇ ᴀɴᴅ ᴀʟɪᴠᴇ\n\n\nᴋᴇᴇᴘ ᴜsɪɴɢ keep using for fun⚡\n\n\n*© ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ - ᴍᴅ\n\n> ɢɪᴛʜᴜʙ :* ",
// add alive msg here 


        STICKER_NAME: process.env.STICKER_NAME || "otf 4 life",
...
// add bot owner name
              ...
              DESCRIPTION: process.env.DESCRIPTION || "*© powered by otf vado",
// add bot owner name    
